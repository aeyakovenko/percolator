...
// Bound-num conversion helpers for full-range differential conformance. The U8
// validator theorem uses a symbolic quotient/remainder decomposition; an
// unconstrained u128 numerator still bit-blasts the division circuit.
...
pub fn kani_eq_portfolio_account_v16_account(
    ...
    kani_eq_provenance_header_v16_account(&a.provenance_header, &b.provenance_header)
        ...
        && a.funding_long_paid_atoms_total.get() == b.funding_long_paid_atoms_total.get()
        && a.funding_long_received_atoms_total.get() == b.funding_long_received_atoms_total.get()
        && a.funding_short_paid_atoms_total.get() == b.funding_short_paid_atoms_total.get()
        && a.funding_short_received_atoms_total.get() == b.funding_short_received_atoms_total.get()
