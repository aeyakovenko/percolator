...
- **Account-local safety:** provenance, active bitmap shape, stale/B-stale
  ...
  account risk is active, fund adverse K/F without settlement deadlock, and
  remain realizable after that risk is fully reversed.
...
| Plain Kani proofs in `src/v16_proofs.rs` | 191 |
