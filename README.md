...
| Class | Count |
| --- | ---: |
| Plain Kani proofs in `tests/proofs_v16.rs` | 265 |
| Plain Kani proofs in `tests/proofs_v16_arithmetic.rs` | 12 |
| Direct plain Kani proofs in `src/v16_proofs.rs` | 43 |
...
| Generated public two-asset batch composition proofs in `src/v16_proofs.rs` | 8 |
...
rg '^closure_conversion_harness!' src/v16_proofs.rs | wc -l
rg '^closure_forfeit_settlement_harness!' src/v16_proofs.rs | wc -l
rg '^closure_negative_pnl_insurance_harness!' src/v16_proofs.rs | wc -l
...
rg '^closure_public_two_asset_batch_harness!' src/v16_proofs.rs | wc -l
